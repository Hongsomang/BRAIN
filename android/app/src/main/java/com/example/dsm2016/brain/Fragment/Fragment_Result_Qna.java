...
/**
 * Created by ghdth on 2018-06-19.
 */

public class Fragment_Result_Qna extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.fragment_result_qna,container,false);
        recyclerView=(RecyclerView)view.findViewById(R.id.rv_qna);
        ...
        RealmResults<DB_Result_All> result= DBActivity.mRealm.where(DB_Result_All.class).equalTo("kind",1).findAll();
